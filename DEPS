...
vars = {
  ...
  # and whatever else without interference from each other.
  'build_revision': 'e37c3970d999371caa2b85da060553ae736cea34',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'clang_revision': '7637a9e0243b44d816d3adc823d7e484f7279fbe',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'partition_allocator_revision': '7864cdced1d6ee0aae78768a808dd798480d76f0',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'skia_revision': '51eabd0d1e4466eb427394912eddb6f7a9d0cafb',
  # Three lines of non-changing comments so that
