...
vars = {
  ...
  'abseil_revision': 'a13888fac08a45c938255c7d9d59b1640f1940e0',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling android_ndk
  # and whatever else without interference from each other.
  'android_ndk_revision': '9644104c8cf85bf1bdce5b1c0691e9778572c3f8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling build
  # and whatever else without interference from each other.
  'build_revision': 'ee10d9605d3bc45e72defd25ce97562e80693655',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'clang_revision': '3a67a5003bc582d62effd4dce12166a1260228f2',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'code_coverage_revision': 'd4ce325ddf3ef43cd62a4b3d8d2c83d9a453dfc8',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling depot_tools
  # and whatever else without interference from each other.
  'depot_tools_revision': 'c9a747c5ed646001df33e798c62bbac0d27c8d08',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'gtest_revision': 'c9461a9b55ba954df0489bab6420eb297bed846b',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling icu
  # and whatever else without interference from each other.
  'icu_revision': '1fa4e3959ec6637182b7318ac1d382799454806d',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'pdfium_tests_revision': '4a2ea198bc43e2dd34f155e7b361e4ca5c9cddb7',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'tools_memory_revision': '3c34a54fcdfc90398f4a561c9b2b10aa03ebe4aa',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling trace_event
  # and whatever else without interference from each other.
  'trace_event_revision': 'd115b033c4e53666b535cbd1985ffe60badad082',
  # Three lines of non-changing comments so that
  ...
  # and whatever else without interference from each other.
  'zlib_revision': '5de432790d674b036289085ff6199bede1d6b795',
}
