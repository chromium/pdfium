...
#ifndef XFA_SRC_FXFA_PARSER_XFA_LAYOUT_APPADAPTER_H_
#define XFA_SRC_FXFA_PARSER_XFA_LAYOUT_APPADAPTER_H_
...
#endif  // XFA_SRC_FXFA_PARSER_XFA_LAYOUT_APPADAPTER_H_
