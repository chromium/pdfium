...
const XFA_SCRIPTATTRIBUTEINFO g_SomAttributeData[] = {
    ...
    {0x1ee2d24d, L"instanceIndex",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_InstanceIndex,
    ...
    {0x6c0d9600, L"currentValue",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Delta_CurrentValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x942643f0, L"savedValue",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Delta_SavedValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xc8da4da7, L"target",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Delta_Target,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xbe52dfbf, L"desc",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Desc, XFA_ScriptType::Basic},
    ...
    {0x54c399e3, L"formattedValue",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Field_FormattedValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x570ce835, L"presence",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Presence, XFA_ScriptType::Basic},
    ...
    {0x5e936ed6, L"fontColor",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_FontColor,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x6826c408, L"parentSubform",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Field_ParentSubform,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    ...
    {0x85fd6faf, L"mandatory",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_Mandatory,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x8e1c2921, L"relevant",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Relevant, XFA_ScriptType::Basic},
    ...
    {0xdcecd663, L"editValue",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Field_EditValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xe07e5061, L"selectedIndex",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Field_SelectedIndex,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    ...
    {0x846599f8, L"transient",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_ExclGroup_Transient,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x85fd6faf, L"mandatory",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_Mandatory,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x8e1c2921, L"relevant",
     ...
     XFA_Attribute::Relevant, XFA_ScriptType::Basic},
    {0xa03cf627, L"rawValue",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_ExclGroup_DefaultAndRawValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xa52682bd, L"{default}",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_ExclGroup_DefaultAndRawValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    ...
    {0xbc254332, L"usehref",
     ...
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    {0xbc8fa350, L"locale",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Subform_Locale,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xc2bd40fd, L"anchorType",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::AnchorType, XFA_ScriptType::Basic},
    ...
    {0x5a50e9e6, L"version",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Handler_Version,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xbc254332, L"usehref",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    ...
    {0xa021b738, L"stateless",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Script_Stateless,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xa52682bd, L"{default}",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_DefaultValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    ...
    {0xbc254332, L"usehref",
     ...
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    {0xb3543a6, L"max",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_InstanceManager_Max,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xb356ca4, L"min",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_InstanceManager_Min,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x6f544d49, L"count",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_InstanceManager_Count,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x25363, L"to",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::To, XFA_ScriptType::Basic},
    ...
    {0xc0811ed, L"use",
     ...
     XFA_Attribute::Use, XFA_ScriptType::Basic},
    {0x28dee6e9, L"format",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Encrypt_Format,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xbc254332, L"usehref",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    ...
    {0xc0811ed, L"use",
     ...
     XFA_Attribute::Use, XFA_ScriptType::Basic},
    {0x2f16a382, L"type",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Extras_Type,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xbc254332, L"usehref",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    ...
    {0xf6b47749, L"lock",
     ...
     XFA_Attribute::Lock, XFA_ScriptType::Basic},
    {0x97be91b, L"content",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Packet_Content,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xc0811ed, L"use",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Use, XFA_ScriptType::Basic},
    ...
    {0xa60dd202, L"length", (XFA_ATTRIBUTE_CALLBACK)&CJX_List::length,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x20146, L"db", (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Source_Db,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xc0811ed, L"use",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Use, XFA_ScriptType::Basic},
    {0xbc254332, L"usehref",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Usehref, XFA_ScriptType::Basic},
    {0xb3543a6, L"max", (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Occur_Max,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xb356ca4, L"min", (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Occur_Min,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xc0811ed, L"use",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Use, XFA_ScriptType::Basic},
    ...
    {0x21aed, L"id",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Attribute_String,
     XFA_Attribute::Id, XFA_ScriptType::Basic},
    {0x234a1, L"ns", (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_NodeClass_Ns,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0x50d1a9d1, L"model",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_NodeClass_Model,
     XFA_Attribute::Unknown, XFA_ScriptType::Object},
    {0xacb4823f, L"isContainer",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_NodeClass_IsContainer,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xe372ae97, L"isNull",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_NodeClass_IsNull,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
    {0xfe612a5b, L"oneOfChild",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_NodeClass_OneOfChild,
     XFA_Attribute::Unknown, XFA_ScriptType::Object},
    {0x97c1c65, L"context",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_ModelClass_Context,
     XFA_Attribute::Unknown, XFA_ScriptType::Object},
    {0x58be2870, L"aliasNode",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_ModelClass_AliasNode,
     XFA_Attribute::Unknown, XFA_ScriptType::Object},
    {0xa52682bd, L"{default}",
     (XFA_ATTRIBUTE_CALLBACK)&CJX_Object::Script_Som_DefaultValue,
     XFA_Attribute::Unknown, XFA_ScriptType::Basic},
